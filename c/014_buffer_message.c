...
static gboolean cb_print_position(GstElement *pipeline)
{
    ...
    if (gst_element_query_position(pipeline, GST_FORMAT_TIME, &pos)
        ...
        g_print("/ %" GST_TIME_FORMAT "\r\033[1A", GST_TIME_ARGS(len));
        if (pos>(gint64)5*1000*1000*1000 && pos<(gint64)10*1000*1000*1000) {
            // erase last two lines.
            g_print("\033[K\033[1B\033[Kseek to 3:40\n");
            sleep(5);
            seek_to_time(pipeline, (gint64)220*1000*1000*1000);
        }
    }
    return TRUE;
}
